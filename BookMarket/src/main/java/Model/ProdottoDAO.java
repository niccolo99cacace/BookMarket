...
public class ProdottoDAO {
	...
	/** prende i primi sei libri con tutte le caratteristiche dal db **/
	...
	/** prende i primi sei libri dal db in ordine di uscita basandosi sull'id **/
	...
	/** ritorna il libro dato l'id in input **/
	...
	/** ritorna il numero di libri di uno specifico genere dato in input **/
  ...
  /** ritorna il numero di libri scritti dall'autore di cui è dato l'id in input (l'id dell'autore è una foreign key in libro) **/
	...
	public List<Prodotto> doRetrieveByNome(String against, int offset, int limit) {
		try (Connection con = ConPool.getConnection()) {
			...
			/** con MATCH ed AGAINST facciamo il match tra gli elementi in match(..) e in against(...)
			 * Con BOOLEAN MODE possiamo fare delle ricerche full-text ed applicare ai caratteri in input (String against) dei modificatori per
			 * specificare il campo di ricerca del match
			 */
